...
// router.get('/', (req: any, res: { writeHead: (arg0: number, arg1: { 'Content-Type': string; }) => void; write: (arg0: string) => void; end: () => void; }) => {
//   res.writeHead(200, { 'Content-Type': 'text/html' });
//   res.write('<h1>Hello from Express.js!</h1>');
//   res.end();
// });
// router.get('/another', (req: { originalUrl: any; }, res: { json: (arg0: { route: any; }) => any; }) => res.json({ route: req.originalUrl }));
// router.post('/', (req: { body: any; }, res: { json: (arg0: { postBody: any; }) => any; }) => res.json({ postBody: req.body }));

// app.use(bodyParser.json());
// app.use('/.netlify/functions/server', router);  // path must route to lambda
// app.use('/', (req: any, res: { sendFile: (arg0: any) => any; }) => res.sendFile(path.join(__dirname, '../index.html')));
